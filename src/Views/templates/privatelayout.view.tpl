...
<body>
  ...
  <div class="Header">
    <div class="Logo">
      <a href="index.php?page=mnt-index">BooksCenter</a>
    </div>        
      
    <div class="BarraBusqueda">      
      <input type="text" placeholder="Busque sus Libros" onfocus="this.placeholder=''"
        onblur="this.placeholder='Busque sus Libros'" id="txtSearch" autocomplete="off">
  ...
  <div class="Sidebar">
    ...
    <br>
    <h5 style="color: white; font-size: 20px; position:absolute; right: 0%; margin-right:45%; margin-top:1.5%">Bienvenido(a)</h5>
    {{with login}}
        <h6 style="color: white; font-size: 20px; position:absolute; right: 0%; margin-right:49%; margin-top:9.5%">{{userName}}</h6>
      {{endwith login}}
    <br>
    <br>
    <div class="Enlaces">      
