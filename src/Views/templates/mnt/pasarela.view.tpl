<section class="ContenedorCompras">
    <div class="Caja1">    
        {{ifnot Cantidad}}
            <h4 style="color: black; margin-left: 5%;">Aun no ha agregado libros a su carrito</h4>
        {{endifnot Cantidad}}    
    </div>
    <div class="Caja2">
...
<section class="Detalle">
    <div class="BoxSvg">
        <p>Productos agregados a la carretilla</p>
    ...
    <div class="BoxDetalle">
        ...
        <div class="OpcionesBox">
            <label for="eliminar">Cancelar Producto</label>
    ...
    <div class="opciones">
        ...
        <input type="radio" name="MetodoPago" id="CDT/DBT" onchange="Rgb(3)">
    </div>
    {{foreach CargarCarrito}}
